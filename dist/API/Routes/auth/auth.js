...
router.post("/auth/login", (0, BodyValidator_1.default)({ schema: login }), auth_1.loginHandler);
...
router.post("/auth/register", (0, BodyValidator_1.default)({ schema: register }), auth_1.RegisterHandler);
